Gem::Specification.new do |s|
  ...
  spec.add_runtime_dependency('sass', '~> 3.7.2')
  spec.add_runtime_dependency('normalize-scss', '~> 7.0.1')
  spec.add_runtime_dependency('bourbon', '~> 5.1.0')
  spec.add_runtime_dependency('neat', '~> 3.0.1')
end